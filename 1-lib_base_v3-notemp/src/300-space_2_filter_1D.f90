  ...
  !*****     Author: D. Dagnino     ************************************/
  !*********************************************************************/
  module m_dag_space_2_filter_1D_zp
   
    interface space_2_filter_1D_zp
      module procedure space_2_filter_1D_zp, space_2_filter_1D_zp_r
    end interface
    ...
    !*********************************************************************/
    !*********************************************************************/
    subroutine space_2_filter_1D_zp( trace, freq1_filt, freq2_filt, type_filt, order_filt, zero_padding, &
                                      nt, dt )
      use m_dag_data_kind
...
!       nt_pad = (1+zero_padding)*nt
    ...
    end subroutine space_2_filter_1D_zp
    ...
    !*********************************************************************/
    !*********************************************************************/
    subroutine space_2_filter_1D_zp_r( trace, freq1_filt, freq2_filt, type_filt, order_filt, zero_padding, &
                                      nt, dt )
      use m_dag_data_kind
      use m_dag_transfer_funct
      use m_dag_mat
...
!       nt_pad = (1+zero_padding)*nt
    ...
    end subroutine space_2_filter_1D_zp_r
  ...
  !***********************************************************************/
  end module m_dag_space_2_filter_1D_zp
