  ...
  !*****     Author: D. Dagnino     ************************************/
  !*********************************************************************/
  module m_dag_filter_1D_zp_extra
    
    interface filter_1D_zp_extra
      module procedure filter_1D_zp_extra, filter_1D_zp_extra_r
    end interface
    ...
    !*********************************************************************/
    !*********************************************************************/
    subroutine filter_1D_zp_extra( trace, freq1_filt, freq2_filt, type_filt, order_filt, zero_padding, nt, dt, extra )
      use m_dag_data_kind
...
!       if ( mod(nt_pad,2) /= 0 ) stop '***** ERROR - filter_1D: mod(nt_pad,2) /= 0 *****'
      ...
      extra2 = extra*dw
      do k = 1,nt_pad
        ftmp(k) = ftmp(k)*exp(-dcmplx(0._r8,extra2*dble(k-1)))
      end do
      !----------------------/
    ...
    end subroutine filter_1D_zp_extra
    ...
    !*********************************************************************/
    !*********************************************************************/
    subroutine filter_1D_zp_extra_r( trace, freq1_filt, freq2_filt, type_filt, order_filt, zero_padding, nt, dt, extra )
      use m_dag_data_kind
      use m_dag_transfer_funct
      use m_dag_factor_number
      implicit none
...
!       if ( mod(nt_pad,2) /= 0 ) stop '***** ERROR - filter_1D: mod(nt_pad,2) /= 0 *****'
    ...
    end subroutine filter_1D_zp_extra_r
   
  !***********************************************************************/
  end module m_dag_filter_1D_zp_extra
