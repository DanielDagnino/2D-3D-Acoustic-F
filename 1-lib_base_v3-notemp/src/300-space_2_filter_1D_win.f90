  ...
  !*****     Author: D. Dagnino     ************************************/
  !*********************************************************************/
  module m_dag_space_2_filter_1D_win_zp
   
    interface space_2_filter_1D_win_zp
      module procedure space_2_filter_1D_win_zp, space_2_filter_1D_win_zp_r
    end interface
    ...
    !*********************************************************************/
    !*********************************************************************/
    subroutine space_2_filter_1D_win_zp( trace, freq1_filt, freq2_filt, p0, p1, type_filt, order_filt, zero_padding, &
                                      nt, dt, ext )
      use m_dag_data_kind
...
!       if ( mod(nt_pad,2) /= 0 ) stop '***** ERROR - space_2_filter_1D: mod(nt_pad,2) /= 0 *****'
    ...
    end subroutine space_2_filter_1D_win_zp
    ...
    !*********************************************************************/
    !*********************************************************************/
    subroutine space_2_filter_1D_win_zp_r( trace, freq1_filt, freq2_filt, p0, p1, type_filt, order_filt, zero_padding, &
                                      nt, dt, ext )
      use m_dag_data_kind
      use m_dag_transfer_funct
      use m_dag_mat
...
!       if ( mod(nt_pad,2) /= 0 ) stop '***** ERROR - space_2_filter_1D: mod(nt_pad,2) /= 0 *****'
    ...
    end subroutine space_2_filter_1D_win_zp_r
  ...
  !***********************************************************************/
  end module m_dag_space_2_filter_1D_win_zp
