  ...
  !*****     Author: D. Dagnino     ************************************/
  !*********************************************************************/
  module m_dag_space_2_filter_2D
    
    interface space_2_filter_2D
      module procedure space_2_filter_2D, space_2_filter_2D_r
    end interface
    ...
    !*********************************************************************/
    !*********************************************************************/
    subroutine space_2_filter_2D( image, &
      ...
      use m_dag_space_2_filter_1D_win
      implicit none
...
!dir$ assume_aligned image(1,1):64
      ...
      if ( xz .eqv. .false. ) then
        do i = 1,nx
          call space_2_filter_1D_win( image(i,:), freq1_filt_z, freq2_filt_z, p0_z, p1_z, type_filt_z, order_filt_z, zero_padding_z, .true., nz, dz, ext )
        end do
      end if  
      
      do j = 1,nz
        call space_2_filter_1D_win( image(:,j), freq1_filt_x, freq2_filt_x, p0_x, p1_x, type_filt_x, order_filt_x, zero_padding_x, .true., nx, dx, ext )
      end do
    ...
    end subroutine space_2_filter_2D
    ...
    !*********************************************************************/
    !*********************************************************************/
    subroutine space_2_filter_2D_r( image, &
        freq1_filt_x, freq2_filt_x, p0_x, p1_x, type_filt_x, order_filt_x, zero_padding_x, &
        freq1_filt_z, freq2_filt_z, p0_z, p1_z, type_filt_z, order_filt_z, zero_padding_z, &
        nx, nz, dx, dz, xz, ext )
      use m_dag_data_kind
...
!dir$ assume_aligned image(1,1):32
      ...
      if ( xz .eqv. .false. ) then
        do i = 1,nx
          call space_2_filter_1D_win_r( image(i,:), freq1_filt_z, freq2_filt_z, p0_z, p1_z, type_filt_z, order_filt_z, zero_padding_z, .true., nz, dz, ext )
        end do
      end if  
      
      do j = 1,nz
        call space_2_filter_1D_win_r( image(:,j), freq1_filt_x, freq2_filt_x, p0_x, p1_x, type_filt_x, order_filt_x, zero_padding_x, .true., nx, dx, ext )
      end do
    ...
    end subroutine space_2_filter_2D_r

    
    
    
  !***********************************************************************/
  end module m_dag_space_2_filter_2D