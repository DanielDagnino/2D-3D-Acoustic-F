  ...
  !*****     Author: D. Dagnino     ************************************/
  !*********************************************************************/
  module m_dag_space_2_filter_1D_win
   
    interface space_2_filter_1D_win
      module procedure space_2_filter_1D_win, space_2_filter_1D_win_r
    end interface
    ...
    !*********************************************************************/
    !*********************************************************************/
    subroutine space_2_filter_1D_win( trace, freq1_filt, freq2_filt, p0, p1, type_filt, order_filt, zero_padding, &
                                      zero_delay, nt, dt, ext )
      use m_dag_data_kind
...
!dir$ assume_aligned trace(1):64
    ...
    end subroutine space_2_filter_1D_win
    ...
    !*********************************************************************/
    !*********************************************************************/
    subroutine space_2_filter_1D_win_r( trace, freq1_filt, freq2_filt, p0, p1, type_filt, order_filt, zero_padding, &
                                      zero_delay, nt, dt, ext )
      use m_dag_data_kind
      use m_dag_transfer_funct
      use m_dag_mat
...
!dir$ assume_aligned trace(1):32
    ...
    end subroutine space_2_filter_1D_win_r
  ...
  !***********************************************************************/
  end module m_dag_space_2_filter_1D_win
